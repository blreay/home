# Generated by Powerlevel10k configuration wizard on 2026-04-18 at 01:23 CST.
...
# angled separators, sharp heads, round tails, 2 lines, disconnected, full frame,
# lightest-ornaments, compact, few icons, concise, instant_prompt=verbose.
...
() {
  ...
  # zzy
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=800
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least this
  # many columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=800
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least
  # COLUMNS * POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT * 0.01 columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT=900
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=205
  ...
  #zzy
  typeset -g POWERLEVEL9K_DIR_HOME_FOLDER_ABBREVIATION=''
