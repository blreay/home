...
if g:miniBufExplMapCTabSwitchBufs
  ...
  noremap <C-Right>           :call <SID>CycleBuffer(1)<CR>:<BS>
  noremap OC           :call <SID>CycleBuffer(1)<CR>:<BS>
  noremap OD           :call <SID>CycleBuffer(0)<CR>:<BS>
  noremap <silent><leader>;   :call <SID>CycleBuffer(1)<CR>:<BS>

  "noremap <C-S-TAB> :call <SID>CycleBuffer(0)<CR>:<BS>
  noremap <silent><leader>N :call <SID>CycleBuffer(0)<CR>:<BS>
  noremap <silent><leader>k :call <SID>CycleBuffer(0)<CR>:<BS>
  noremap <silent><leader>j   :call <SID>CycleBuffer(0)<CR>:<BS>
